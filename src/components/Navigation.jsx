...
return (
	<>
	<nav className="border-b-2 border-gray-200 bg-yellow-100">
	<div ref={menuRef} className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 relative">
		<a href="#" className="flex items-center">
			<span className="self-center text-2xl text-gray-900 font-semibold whitespace-nowrap">CryptoUpdate</span>
		</a>
		...
		<div className="hidden w-full md:block md:w-auto">
			...
			{[
				...
				<li key={url} >
					<button className="block transition ease-in-out delay-120 hover:scale-110
					hover:bg-indigo-200 rounded-xl duration-300 md:p-1 uppercase" 
